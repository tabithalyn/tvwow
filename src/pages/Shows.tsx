...
const Shows = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center flex-wrap gap-3 h-full mt-32">
              ...
              <div key={index} className="w-full bg-mutedBeige flex justify-center flex-wrap rounded-2xl overflow-hidden">
                ...
                <div className="w-3/4 bg-mutedBeige py-2 text-center text-4xl font-extrabold flex flex-wrap justify-center">
                  ...
                  <div className="flex flex-wrap justify-center w-full gap-2 p-2">
                    <Link to={`/tv-show/${item.id}`} className="w-[97%] flex items-center justify-center text-center rounded-xl bg-lightBlue uppercase text-[12px] font-medium hover:tracking-wider transition-all hover:bg-opacity-80 border border-transparent hover:border hover:border-[#50c6c2]">More Info</Link>
                    <Link to={`/seasons/${item.id}`} className="w-[48%] flex items-center justify-center text-center rounded-xl bg-orangey uppercase text-[12px] font-medium hover:tracking-wider transition-all hover:bg-opacity-80 border border-transparent hover:border hover:border-[#c68b50]">Seasons</Link>
                    <Link to={`/episodes/${item.id}`} className="w-[48%] flex items-center justify-center text-center bg-pinky rounded-xl uppercase text-[12px] font-medium hover:tracking-wider transition-all hover:bg-opacity-80 border border-transparent hover:border hover:border-[#ad5775]">Episodes</Link>
                  </div>
                </div>
              </div>
            ))}
